...
assert.match(html, /class="states"/);
assert.match(html, /class="seats"/);
...
assert.match(css, /grid-template-columns:\s*1fr 360px 280px/);
assert.match(css, /\.states button\.ok::before/);
assert.match(css, /\.states button\.warn::before/);
assert.match(css, /\.states button\.bad::before/);
assert.match(css, /\.switcher/);
assert.match(css, /\.empty h1/);
assert.match(css, /\.seats/);
assert.match(css, /\.rowline/);
...
assert.match(chat, /in studio/);
assert.match(chat, /className = seat.id === state.selectedSeat \? "on"/);
...
assert.match(board, /Agents/);
assert.match(board, /Watches/);
assert.match(board, /"Diff"/);
assert.match(board, /rowline/);
assert.match(board, /sectionHead/);
...
assert.match(tray, /connector.label/);
assert.match(tray, /case "live"/);
assert.match(tray, /return "ok"/);
