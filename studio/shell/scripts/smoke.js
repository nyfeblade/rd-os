...
assert.match(css, /grid-template-columns:\s*1\.25fr 360px/);
assert.match(css, /\.conn\.auth::after|\.icons button\.auth::after/);
assert.match(css, /\.conn\.live::after|\.icons button\.live::after/);
assert.match(css, /1fr 400px 340px/);
...
assert.match(board, /CA \/ builders/);
