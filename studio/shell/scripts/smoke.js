...
assert.match(html, /id="cta-seat">Seat</);
...
assert.match(js, /pendingHitl/);
assert.match(js, /Deploy to production/);
...
assert.match(chat, /Connect to chat/);
...
assert.match(read("lib/seats-bridge.js"), /MISSING_SECRET/);
