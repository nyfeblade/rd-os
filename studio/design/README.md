...
| `CONNECTORS-TWO-WAY.md` | Canonical two-way lock — inbox + outbound reply; P0 GitHub+Slack |
...
| `quiet-studio.html` | Tray live\|needs_auth; GitHub inbox thread; bound reply; Board bot-send gate |
